...
return [
    ...
    */
    ...
    "check_marques" => "Vous devez sélectionner entre 3 et 10 marques.",
    "check_icones"  => "Vous devez choisir entre 1 et 5 icônes de mode.",
    "check_dispo"  => "Vous devez choisir au moins un créneau horaire.",
    ...
    */
    ...
    'custom' => [
        'disp' => ['required' => 'Vous devez choisir au moins un créneau horaire.'],
        'indisp' => ['required' => 'Vous devez choisir au moins un créneau horaire.']
    ],
