...
<table id="Tableau_01" width="640" border="0" cellpadding="0" cellspacing="0" class="resize">
       ...
       <td align="left" style="font-size:0px"><table align="left" border="0" cellpadding="0" cellspacing="0" width="640" class="resize">
        <tr>
            <td class="hide" width="120">
                ...
                <img src="{{ url('img/email/007_Rappel_prestation_J-2/logo1.gif') }}" width="120" height="171" alt="" border="0"></a></td>
            <td class="resize" width="397">
                <a href="http://www.mayao.fr" target="_blank">
                <img src="{{ url('img/email/007_Rappel_prestation_J-2/logo1.gif') }}" width="397" height="171" alt="" border="0" class="resize"></a></td>
            <td class="hide" width="123">
                <a href="http://www.mayao.fr" target="_blank">
                <img src="{{ url('img/email/007_Rappel_prestation_J-2/logo1.gif') }}" width="123" height="171" alt="" border="0"></a></td>
        </tr>
      </table></td>
    </tr>
	<tr>
       <td align="left" style="font-size:0px"><table align="left" border="0" cellpadding="0" cellspacing="0" width="640" class="resize">
            <tr>
                ...
                Tic tac tic tac&hellip;c&rsquo;est bient&ocirc;t  l&rsquo;heure de prendre soin de vous&nbsp;! <br /><br />
                Un memento de votre s&eacute;ance de  personal shopping command&eacute;e avec {{$commande->userps->prenom}} {{$commande->userps->nom}}<br /><br />
                <strong>Date de la prestation : {{$commande->date}}</td>
    ...
    <tr>
        <td class="resize" width="640" height="36" align="center">
            <a href="{{ url('/espace') }}"><img src="{{ url('img/email/007_Rappel_prestation_J-2/btn_aac.gif') }}" width="295" height="36" alt="" class="resize"></a></td>
    </tr>
    <tr>
       <td align="left" style="font-size:0px"><table align="left" border="0" cellpadding="0" cellspacing="0" width="640" class="resize">
            <tr>
                  ...
                  <table border="0" cellspacing="0" cellpadding="0" align="left" class="resize">
                    <tr>
                        <td class="resize" width="320">
                            ...
                            <img src="{{ url('img/email/007_Rappel_prestation_J-2/mayao_blog.gif') }}" width="320" height="92" alt="" border="0"></a></td>
                    </tr>
                  </table>
                  <!--[if mso]></td><td><![endif]-->
                  <table border="0" cellspacing="0" cellpadding="0" align="left" class="resize">
                    <tr>
                        <td>
                            ...
                            <img src="{{ url('img/email/007_Rappel_prestation_J-2/facebook.gif') }}" width="85" height="92" alt="" border="0"></a></td>
                        <td>
                            <a href="https://twitter.com/mayao_fr" target="_blank">
                            <img src="{{ url('img/email/007_Rappel_prestation_J-2/twitter.gif') }}" width="81" height="92" alt="" border="0"></a></td>
                        <td>
                            <a href="https://instagram.com/mayao_fr/" target="_blank">
                            <img src="{{ url('img/email/007_Rappel_prestation_J-2/instagram.gif') }}" width="77" height="92" alt="" border="0"></a></td>
                        <td>
                            <a href="https://www.pinterest.com/mayao_blog/" target="_blank">
                            <img src="{{ url('img/email/007_Rappel_prestation_J-2/pinterest.gif') }}" width="77" height="92" alt="" border="0"></a></td>
                   </tr>
                 </table>
