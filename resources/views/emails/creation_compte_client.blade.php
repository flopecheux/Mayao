...
<table id="Tableau_01" width="640" border="0" cellpadding="0" cellspacing="0" class="resize">
       ...
       <td align="left" style="font-size:0px"><table align="left" border="0" cellpadding="0" cellspacing="0" width="640" class="resize">
        <tr>
            <td class="hide" width="120">
                ...
                <img src="{{ url('img/email/001_Creation_compte_client/logo1.gif') }}" width="120" height="171" alt="" border="0"></a></td>
            <td class="resize" width="397">
                <a href="http://www.mayao.fr" target="_blank">
                <img src="{{ url('img/email/001_Creation_compte_client/logo2.gif') }}" width="397" height="171" alt="" border="0" class="resize"></a></td>
            <td class="hide" width="123">
                <a href="http://www.mayao.fr" target="_blank">
                <img src="{{ url('img/email/001_Creation_compte_client/logo3.gif') }}" width="123" height="171" alt="" border="0"></a></td>
        </tr>
      </table></td>
    </tr>
	<tr>
       <td align="left" style="font-size:0px"><table align="left" border="0" cellpadding="0" cellspacing="0" width="640" class="resize">
            <tr>
                ...
                <td class="texte_center" width="540" height="180" style="font-family:Arial; font-size:16px; color:#000000; text-decoration:none;">
                Bonjour {{ $user->prenom }},<br><br>
                  Bienvenue sur MAYAO ! <br><br>
                  Votre espace personnel est cr&eacute;&eacute;, il vous permet de g&eacute;rer votre profil et d'acc&eacute;der &agrave; vos informations &agrave; tout moment.<br><br>
                Naviguez, r&eacute;servez, profitez&hellip;nous sommes l&agrave; pour prendre soin de vous.<br></td>
    ...
    <tr>
        <td class="resize" width="640" height="36" align="center">
            <a href="{{ url() }}"><img src="{{ url('img/email/001_Creation_compte_client/btn_aac.gif') }}" width="246" height="36" alt=""></a></td>
    </tr>
    <tr>
       <td align="left" style="font-size:0px"><table align="left" border="0" cellpadding="0" cellspacing="0" width="640" class="resize">
            <tr>
                <td class="hide" width="58"></td>
                <td class="texte_center" width="540" height="60" style="font-family:Arial; font-size:16px; color:#000000; text-decoration:none;">                  Chaleureusement v&ocirc;tre,<br />
                L'&eacute;quipe MAYAO</td>
                <td class="hide" width="42">&nbsp;</td>
            </tr>
        </table></td>
    </tr>
                  ...
                  <table border="0" cellspacing="0" cellpadding="0" align="left" class="resize">
                    <tr>
                        <td class="resize" width="320">
                            ...
                            <img src="{{ url('img/email/001_Creation_compte_client/mayao_blog.gif') }}" width="320" height="102" alt="" border="0"></a></td>
                    </tr>
                  </table>
                  <!--[if mso]></td><td><![endif]-->
                  <table border="0" cellspacing="0" cellpadding="0" align="left" class="resize">
                    <tr>
                        <td>
                            ...
                            <img src="{{ url('img/email/001_Creation_compte_client/facebook.gif') }}" width="86" height="102" alt="" border="0"></a></td>
                        <td>
                            <a href="https://twitter.com/mayao_fr" target="_blank">
                            <img src="{{ url('img/email/001_Creation_compte_client/twitter.gif') }}" width="77" height="102" alt="" border="0"></a></td>
                        <td>
                            <a href="https://instagram.com/mayao_fr/" target="_blank">
                            <img src="{{ url('img/email/001_Creation_compte_client/instagram.gif') }}" width="79" height="102" alt="" border="0"></a></td>
                        <td>
                            <a href="https://www.pinterest.com/mayao_blog/" target="_blank">
                            <img src="{{ url('img/email/001_Creation_compte_client/pinterest.gif') }}" width="78" height="102" alt="" border="0"></a></td>
                   </tr>
                 </table>
