       ...
       <td align="left" style="font-size:0px"><table align="left" border="0" cellpadding="0" cellspacing="0" width="640" class="resize">
        <tr>
            <td class="hide" width="120">
                ...
                <img src="{{ url('img/email/005_Confirmation_commande_PS/logo1.gif') }}" width="120" height="171" alt="" border="0"></a></td>
            <td class="resize" width="397">
                <a href="http://www.mayao.fr" target="_blank">
                <img src="{{ url('img/email/005_Confirmation_commande_PS/logo2.gif') }}" width="397" height="171" alt="" border="0" class="resize"></a></td>
            <td class="hide" width="123">
                <a href="http://www.mayao.fr" target="_blank">
                <img src="{{ url('img/email/005_Confirmation_commande_PS/logo3.gif') }}" width="123" height="171" alt="" border="0"></a></td>
        </tr>
      </table></td>
    </tr>
	<tr>
       <td align="left" style="font-size:0px"><table align="left" border="0" cellpadding="0" cellspacing="0" width="640" class="resize">
            <tr>
                ...
                Bonjour {{ $commande->userps->prenom }},<br /><br />
                Nous avons le plaisir de vous confirmer la commande de {{ $commande->user->prenom }} {{ $commande->user->nom }} : <br /><br />
{{ end($horaires) - $horaires[0] + 1 }}H de personal shopping le {{ Carbon::createFromFormat('Y-m-d', $commande->date)->format('d/m/Y') }} de {{ $horaires[0] }}H &agrave; {{ end($horaires) + 1 }}H<br /><br />
{{ $commande->user->prenom }} attend impatiemment d’en savoir plus sur les modalités de votre séance. <br /></td>
    ...
    <tr>
        <td class="resize" width="640" height="36" align="center">
            <a href="{{ url('/espace') }}"><img src="{{ url('img/email/005_Confirmation_commande_PS/btn_aac.gif') }}" width="386" height="36" alt="" class="resize"></a></td>
    </tr>
    <tr>
       <td align="left" style="font-size:0px"><table align="left" border="0" cellpadding="0" cellspacing="0" width="640" class="resize">
            <tr>
                  ...
                  <table border="0" cellspacing="0" cellpadding="0" align="left" class="resize">
                    <tr>
                        <td class="resize" width="320">
                            ...
                            <img src="{{ url('img/email/005_Confirmation_commande_PS/mayao_blog.gif') }}" width="320" height="92" alt="" border="0"></a></td>
                    </tr>
                  </table>
                  <!--[if mso]></td><td><![endif]-->
                  <table border="0" cellspacing="0" cellpadding="0" align="left" class="resize">
                    <tr>
                        <td>
                            ...
                            <img src="{{ url('img/email/005_Confirmation_commande_PS/facebook.gif') }}" width="85" height="92" alt="" border="0"></a></td>
                        <td>
                            <a href="https://twitter.com/mayao_fr" target="_blank">
                            <img src="{{ url('img/email/005_Confirmation_commande_PS/twitter.gif') }}" width="81" height="92" alt="" border="0"></a></td>
                        <td>
                            <a href="https://instagram.com/mayao_fr/" target="_blank">
                            <img src="{{ url('img/email/005_Confirmation_commande_PS/instagram.gif') }}" width="77" height="92" alt="" border="0"></a></td>
                        <td>
                            <a href="https://www.pinterest.com/mayao_blog/" target="_blank">
                            <img src="{{ url('img/email/005_Confirmation_commande_PS/pinterest.gif') }}" width="77" height="92" alt="" border="0"></a></td>
                   </tr>
                 </table>
